                            ...
                            <table id="dataTable" class="table table-bordered table-striped dataTable" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->event->tanggal }}</td>
                                        <td>{{ $data->event->jam }} WIB</td>
                                        <td>{{ $data->event->nama_event }}</td>
                                        <td>{{ $data->event->detail_event }}</td>
                                        <td>{{ $data->event->diskon_event.' %' }}</td>
                                        <td>{{ 'Rp '.number_format($data->event->harga_event,0,',','.') }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
